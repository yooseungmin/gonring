"""
TB Engine API 단위 테스트 스크립트
환경 변수에서 설정을 불러오고 TB Engine 서비스만 테스트합니다.
"""
import os
import sys
import asyncio
...
# 실행 스크립트 경로를 기준으로 상위 디렉토리를 import path에 추가
...
async def test_recommend_tags():
    ...
    with patch('httpx.AsyncClient.post') as mock_post:
        ...
        # async context manager를 흉내내기 위한 설정
...
async def test_search_content():
    ...
    with patch('httpx.AsyncClient') as MockClient:
        ...
        # MockClient가 mock_client를 반환하도록 설정
